...
grep ${THIS_DIR}/trace_outputs/tmp -e "sender" >> ${THIS_DIR}/trace_outputs/${TIME}-inclusive.txt
...
grep ${THIS_DIR}/trace_outputs/tmp -e "sender" >> ${THIS_DIR}/trace_outputs/${TIME}-exclusive.txt
